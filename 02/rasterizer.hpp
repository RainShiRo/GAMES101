...
namespace rst
{
    ...
    private:
        ...
        int SMAA(float x,float y, float z, const Vector3f* _v, const Triangle& t,int n,int m);
    ...
    private:
        ...
        std::vector<Eigen::Vector3f> smaa_frame_buf;
        std::vector<float> depth_buf;
        std::vector<float> smaa_depth_buf;
